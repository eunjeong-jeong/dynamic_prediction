...
bfnx1.1 <- SchoenSmooth(fit=fitCox5, Stime=survival.time, status=survival.status, span=span, order=1)    #order=1
bfnx1.0 <- SchoenSmooth(fit=fitCox5, Stime=survival.time, status=survival.status, span=span, order=0)    #order=0
